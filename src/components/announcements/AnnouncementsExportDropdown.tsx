...
interface AnnouncementsExportDropdownProps {
  theme: string;
  onExportPDF: () => void;
  onExportCSV: () => void;
  t: (key: string) => string;
...
const AnnouncementsExportDropdown: React.FC<AnnouncementsExportDropdownProps> = ({
  theme,
  onExportPDF,
  onExportCSV,
  t,
...
export default AnnouncementsExportDropdown;
