...
import { FaSpinner, FaRegCircle, FaExclamationTriangle, FaArrowRight } from 'react-icons/fa';
      ...
      {loading ? (
        ...
        <ul className="space-y-5">
          {tasks.map((task) => {
            ...
            let titleClass = theme === 'dark' ? "text-gray-100" : "text-gray-900";
            let deadlineClass = theme === 'dark' ? "text-gray-300" : "text-primary-dark";
            let icon = (
            ...
            if (isOverdue) {
              ...
              titleClass = theme === 'dark' ? "text-gray-100 font-bold" : "text-gray-900 font-bold";
              deadlineClass = theme === 'dark' ? "text-gray-400 font-semibold" : "text-gray-600 font-semibold";
              icon = (
            ...
            return (
              ...
              >
                <div className="flex-1 pr-4">
                  <span className={`block font-bold text-xl leading-tight ${titleClass}`}>
                    {task.title}
                  </span>
                  {task.description && (
                  ...
                  {updatingTaskId === task._id ? (
                    ...
                    <button
                      ...
                      className={`focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-full p-1 ${
                        isOverdue ? 'cursor-not-allowed opacity-70' : 'focus:ring-primary-light'
                      }`}
                      title={tooltipText}
