...
const StorageHeader: React.FC<StorageHeaderProps> = React.memo(
  ({
    ...
    return (
      <div className="bg-white/80 backdrop-blur-md rounded-2xl px-2 sm:px-4 md:px-6 pt-4 sm:pt-6 pb-3 border border-gray-200/50 w-full max-w-full overflow-x-auto">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4 mb-4 w-full max-w-full">
          <div className="p-2 sm:p-3 bg-blue-100 rounded-xl flex-shrink-0">
            <FaHdd className="text-xl sm:text-2xl text-blue-600" />
          </div>
          <div className="flex-1 min-w-0">
            <h3 className="text-base sm:text-lg font-semibold text-gray-800">
              {t("storageUsage")}
            </h3>
            <p className="text-xs sm:text-sm text-gray-600">{t("monitorStorage")}</p>
          </div>
          <div className="flex gap-2 w-full sm:w-auto mt-2 sm:mt-0 max-w-full overflow-x-auto">
            <Button
              onClick={handleSignatureClick}
              className="flex-1 flex items-center justify-center gap-1 px-2 sm:px-6 py-1.5 sm:py-3 bg-blue-500 text-white rounded-xl hover:bg-blue-700 transform hover:scale-102 transition-all duration-200 text-xs sm:text-base min-h-0 h-8 sm:h-auto"
              style={{ minWidth: 0 }}
              variant="default"
            >
            ...
            <Button
              ...
              className="flex-1 flex items-center justify-center gap-1 px-2 sm:px-6 py-1.5 sm:py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-800 transition-all duration-200 text-xs sm:text-base min-h-0 h-8 sm:h-auto"
              style={{ minWidth: 0 }}
              variant="default"
            >
