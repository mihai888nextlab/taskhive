      ...
      <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 w-full">
        ...
        <div className="flex-1 relative min-w-0">
          ...
          <Input
            ...
            className="w-full pl-10 pr-4 py-2 sm:py-3 text-xs sm:text-sm rounded-xl border transition-all duration-200 bg-white border-gray-200 text-gray-900 placeholder-gray-500 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
          />
        </div>
        {/* Sort Dropdown */}
        <div className="relative w-full sm:w-auto">
          ...
          <Select value={sortBy} onValueChange={handleSortByChange}>
            <SelectTrigger className="w-full pl-9 pr-8 py-2 sm:py-3 text-xs sm:text-sm rounded-xl border border-gray-200 bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 min-w-[120px] sm:min-w-[160px]">
              <SelectValue placeholder={t("sortBy")} />
            </SelectTrigger>
            <SelectContent className="bg-white border border-gray-300 rounded-lg p-0">
              <SelectItem
                value="name"
                className="text-gray-900 bg-white hover:bg-blue-50 focus:bg-blue-100 data-[state=checked]:bg-blue-100 data-[state=checked]:text-blue-700 px-4 py-2 text-xs sm:text-sm cursor-pointer transition-colors"
              >
                {t("sortByName")}
              </SelectItem>
              <SelectItem
