  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-shrink-0 p-3">
        ...
        {/* Filter & Sort Button: always inline with search and export on desktop, below on mobile */}
        <div className="flex gap-2 items-center w-full mt-2 md:mt-0 md:w-auto md:ml-2 md:gap-2">
          <Button
            type="button"
            className="rounded-xl px-4 py-2 font-semibold text-sm bg-red-500 hover:bg-red-600 text-white shadow flex items-center justify-center gap-2 w-full md:w-auto"
