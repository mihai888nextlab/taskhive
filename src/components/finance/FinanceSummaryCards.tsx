...
export default function FinanceSummaryCards({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
      {/* Expenses Card */}
      <Card className={`rounded-xl p-5 border shadow-sm ${theme === 'dark' ? 'bg-red-900/10 border-gray-700' : 'bg-red-50/50 border-red-100'}`}>
      ...
      {/* Income Card */}
      <Card className={`rounded-xl p-5 border shadow-sm ${theme === 'dark' ? 'bg-green-900/10 border-gray-700' : 'bg-green-50/50 border-green-100'}`}>
        <CardContent className="p-0">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center">
      ...
      {/* Profit Card */}
      <Card className={`rounded-xl p-5 border shadow-sm ${
        theme === 'dark' 
