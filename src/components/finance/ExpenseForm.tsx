    ...
    <form onSubmit={handleFormSubmit} className="space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          >
            <SelectTrigger
              className={`w-full pl-9 pr-8 text-sm rounded-xl border transition-all duration-200 min-w-[120px] focus:ring-2 focus:ring-red-500 focus:border-red-500 ${theme === 'dark' ? 'bg-gray-800 border-gray-700 text-white placeholder-gray-400' : 'bg-white border-gray-300 text-gray-900 placeholder-gray-500'}`}
              style={{ height: "36px" }}
            >
            ...
            <SelectContent className={`${theme === 'dark' ? 'bg-gray-900 border-gray-700 text-white' : 'bg-white border border-gray-300'} rounded-lg p-0`}>
              {categories.map(cat => (
                <SelectItem
                  key={cat}
                  value={cat}
                  className={`${theme === 'dark' ? 'text-white bg-gray-900 hover:bg-red-950 focus:bg-red-950 data-[state=checked]:bg-red-950 data-[state=checked]:text-red-300' : 'text-gray-900 bg-white hover:bg-red-50 focus:bg-red-100 data-[state=checked]:bg-red-100 data-[state=checked]:text-red-700'} px-4 py-2 text-sm cursor-pointer transition-colors`}
                >
                  {cat}
                </SelectItem>
              ))}
