  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex flex-col relative">
      ...
      <div className="flex-1 p-6">
        ...
        >
          {/* Local User */}
          <div className="relative bg-slate-800/50 backdrop-blur-sm rounded-2xl overflow-hidden border border-slate-700/30 group hover:border-slate-600/50 transition-all duration-300">
            <LocalUser
          ...
          {remoteUsers.map((user) => (
            <div
              key={user.uid}
              className="relative bg-slate-800/50 backdrop-blur-sm rounded-2xl overflow-hidden border border-slate-700/30 group hover:border-slate-600/50 transition-all duration-300"
            >
