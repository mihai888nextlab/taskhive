...
const FinancePage = () => {
  ...
  return (
    <div className={`flex flex-col h-screen ${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-100'}`}>
      ...
      <div className="flex-1 px-4 lg:px-8 py-2 overflow-hidden">
        <div className="max-w-7xl mx-auto h-full">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-full">
            ...
            <div className="lg:col-span-1 flex flex-col gap-4">
              ...
              />
              {/* Form */}
              <div className={`${theme === "dark" ? "bg-gray-800" : "bg-white"} rounded-2xl border ${theme === "dark" ? "border-gray-700" : "border-gray-200"} h-fit max-h-full flex flex-col overflow-hidden`}>
                {/* Form Header */}
            ...
            <div className="lg:col-span-2">
              <div className={`${theme === "dark" ? "bg-gray-800" : "bg-white"} rounded-2xl border ${theme === "dark" ? "border-gray-700" : "border-gray-200"} h-full max-h-[700px] flex flex-col overflow-hidden`}>
                {/* List Header */}
                <div className={`flex-shrink-0 px-4 py-3 ${
                  logic.activeTab === 'expenses' 
                    ? theme === "dark" ? "bg-red-900/20 border-gray-600" : "bg-red-50 border-gray-200"
