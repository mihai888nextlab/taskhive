...
const SelectCompanyPage = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`flex flex-col w-full max-w-[1200px] rounded-2xl border shadow-lg overflow-hidden mx-4
          ${theme === "dark" ? "bg-[#23272f] border-gray-700" : "bg-white border-gray-200"}`}
        >
          {/* Container Header with Better Company Icon */}
          <div
            className={`flex items-center gap-4 w-full px-8 py-6 border-b ${theme === "dark" ? "bg-blue-50/5 border-blue-800" : "bg-blue-50 border-blue-200"}`}
            style={theme === "dark" ? { opacity: 0.97 } : undefined}
          >
            {/* FA Building Icon for Company */}
            <div
              className={`p-3 rounded-xl flex items-center justify-center ${theme === "dark" ? "bg-blue-700" : "bg-blue-200"}`}
            ...
            <div className="flex-1">
              <h1
                className={`text-2xl font-bold mb-1 text-left ${theme === "dark" ? "text-white" : "text-gray-900"}`}
              >
          ...
          <div
            className="flex flex-wrap gap-x-8 gap-y-6 justify-center w-full px-4 py-4 overflow-y-auto scrollbar-thin scrollbar-thumb-blue-400 scrollbar-track-blue-100"
          ...
          >
            {user?.companies?.map((company) => (
              ...
              >
                ...
                <div
                  className={`px-6 py-4 border-b ${theme === "dark" ? "bg-blue-900 border-blue-800" : "bg-blue-50 border-blue-200"}`}
                ...
                >
                  <span
                    className={`text-base font-medium text-center ${theme === "dark" ? "text-gray-300" : "text-gray-700"}`}
                    style={{
                      whiteSpace: "nowrap",
                      overflow: "hidden",
